...
c1.markdown(kpi_color('S&P 500 (%)',     f'{sp500_pct:.2f}%'), unsafe_allow_html=True)
c2.markdown(kpi_color('VIX (%)',             f'{vix_close:.2f}%'), unsafe_allow_html=True)
c3.markdown(kpi_color('Brent (%)',       f'{brent_pct:.2f}%'), unsafe_allow_html=True)
c4.markdown(kpi_color('WTI (%)',         f'{wti_pct:.2f}%'), unsafe_allow_html=True)
st.markdown("")
c1, c2, c3, c4 = st.columns(4)
c1.markdown(kpi_color('Gold (%)',        f'{gold_pct:.2f}%'), unsafe_allow_html=True)
c2.markdown(kpi_color('SNB Leitzins',    f'{leitzins:.2f}%'), unsafe_allow_html=True)
